...
- [ ] Calculate nightly charge from assigned room/rate plan.
- [ ] For MVP, create room-night folio line items at check-in for the reserved stay dates.
- [ ] Document that later night audit will replace upfront posting.
